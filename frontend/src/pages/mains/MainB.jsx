          ...
          <Slider {...settings}>
            <div>
              <S.ChartInfo>
                <h3>플라스틱 생산량</h3>
                <p>
                  플라스틱은 생산단계에서 61%, 가공단계에서 30%, 소각 등 영구폐기 단계에서 9%의
                  이산화탄소가 각각 배출됩니다. 이산화탄소는 온실가스의 주범으로 여겨지는 가장
                  대표적인 환경오염 물질이죠. 해가 지날수록 점점 증가하기만 하는 플라스틱 총
                  생산량이 보이시나요? 우리가 많이 소비하는 만큼 생산량도 늘어날 수밖에 없지
                  않을까요??
                </p>
              </S.ChartInfo>
              <S.ChartBox>
            ...
            <div>
              <S.ChartInfo>
                <h3>웨스트 데이터</h3>
                <p>
                  우리가 버리는 플라스틱을 포함하는 폐합성수지류의 양을 비교해 봅시다. (폐합성수지류
                  : 비닐류, 발포수지류, PET 병, 기타) 코로나가 시작된 2019년부터 혼합배출된
                  폐합성수지류의 양의 급격한 증가를 볼 수 있네요. 배달음식도 많이 이용했지만,
                  편리함이 익숙해져 일회용 플라스틱을 많이 사용하고 있지는 않나요?
                </p>
              </S.ChartInfo>
              <S.ChartBox>
                <ResponsiveContainer width="80%" height="60%">
